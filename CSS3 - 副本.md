...
[兼容性参考](https://blog.csdn.net/VRSUQ/article/details/105988971?utm_medium=distribute.pc_relevant_t0.none-task-blog-BlogCommendFromMachineLearnPai2-1.channel_param&depth_1-utm_source=distribute.pc_relevant_t0.none-task-blog-BlogCommendFromMachineLearnPai2-1.channel_param)
...
div + p的意思是：找到div元素下的下一个兄弟元素节点，看看该元素节点是不是p，而div的下一个兄弟元素节点是span，显然不是，因此，想要匹配第一个p，上面的要改为span + p
...
<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224057.png" alt="css3 (20)" style="zoom:50%;" />



<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224104.png" alt="css3 (22)" style="zoom:50%;" />

<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224108.png" alt="css3 (19)" style="zoom:50%;" />
...
![css3 (14)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224113.png)
...
![css3 (15)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224118.png)
...
<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224122.png" alt="css3 (16)" style="zoom:50%;" />
...
<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224126.png" alt="css3 (17)" style="zoom:50%;" />
...
![css3 (13)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224130.png)
...
![css (4)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224135.png)
...
![css (3)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224143.png)
...
![css (2)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224148.png)
...
- border-image-slice：有1到4值，分别是top，right，bottom，left，只能填数字或百分比，顺序是上右下左，不添值的话默认100%。最后还有一个fill值，填了fill最中间的就不会被忽略
  ...
  ![css3 (2)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224154.png)
...
![css3 (3)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224202.png)
...
![css3 (4)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224209.png)
...
![css3 (6)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224226.png)

![css3 (7)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225638.png)
...
![css3 (7)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224233.png)
...
![css3 (5)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224238.png)
...
<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224244.png" alt="css3 (9)" style="zoom:50%;" />
...
<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224248.png" alt="css3 (8)" style="zoom: 50%;" />
...
![css3 (12)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224258.png)
...
![css3 (1)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224302.png)
...
![noAccess](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224307.png)
...
![column5 (2)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224312.png)
...
![column5 (3)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224316.png)
...
<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224347.png" alt="column5 (5)" style="zoom:50%;" />



实际的效果变成了3行3列，出现这种情况的原因是我们在加入第9张图片之前的时候，此时的页面布局如下，是正常的

<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224351.png" alt="column5 (6)" style="zoom:50%;" />

但当我们插入第9张图片时，发现所有柱高都一致，这时会减到3列，变成第一列3行，第二列3行，第三列2行，这时就存在两个最高柱高了，然后才插入图片。

如果继续插入第10张就会回到我们预想中4列的样子了，因为存在一个最高柱高

<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224356.png" alt="column5 (1)" style="zoom:50%;" />
...
![IE6混杂模式](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224414.png)
...
![flex-grow](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224428.png)
...
#### flex-shrink属性的计算规则
  ...
  ![shrink属性的计算规则](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224434.png)
...
![shrink](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224443.png)

![绿色盒子区](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224448.png)

![蓝色盒子区](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224452.png)
...
![shrink1](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224459.png)
...
![居中](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224508.png)
...
![动态导航栏](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224513.png)
...
![等分布局](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224518.png)
...
![image-20200829095200072](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224522.png)
...
![image-20200829100102892](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224532.png)
...
![st坐标轴](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224538.png)
...
![三次贝塞尔曲线](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224545.gif)
...
![二次贝塞尔曲线](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224550.gif)
...
![一次贝塞尔曲线](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224554.gif)
...
![image-20200312170454950](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224608.png)
...
![image-20200313121930918](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224616.png)
...
![image-20200313121839483](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224623.png)
...
![Rec 0019](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224628.gif)



## 8.transform

![chrome_XoWVjE1MRw](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225935.png)
...
![image-20200313173033398](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224638.png)

- rotateX：沿着X轴旋转，从右往左看，顺时针旋转为正，逆时针旋转为父

  ![EapmKXhL4Z](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/EapmKXhL4Z.gif)

- rotateY：沿着Y轴旋转，从上往下看，顺时针旋转为父，逆时针旋转为正

  ![leiwJ0yWGx](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/leiwJ0yWGx.gif)
...
![image-20200313164948151](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224642.png)
...
![image-20200313170127420](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224646.png)
...
![image-20200313172904686](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224651.png)
...
>
> ![坐标轴刻度](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224656.png)
>
> 
>
...
> 
>
> 原图![scale原图](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224708.png)
>
> scale(2,1)![scale(D:/Typora/typora-user-images/CSS3/scale(2,1)-1584114956682.png)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224713.png)
>
> rotate(-75deg)![image-20200313210723526](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224717.png)
>
> 
>
> scale(2,1)
>
> ![scale(2,1)](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224722.png)
...
- scale3d(x,y,z)：伸缩元素的XYZ变化坐标轴的刻度
  ...
  ![scale拉伸](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224732.png)
...
![skew前](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224737.png)

skew后

![skew后](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224741.png)

我们发现，尽管元素发生了倾斜，但是在Y轴的高度依旧没有发生变化，依然和未拉伸的图形高度保持一致，根据数学常识，元素倾斜后，在原Y轴上的高度一定会减少，而不是没有变化，这只能说明一个问题，就是不仅坐标轴倾斜了，连坐标轴的刻度都被拉伸了了

![skew](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224747.png)
...
![image-20200314142914422](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224752.png)
...
![景深](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224810.png)



perspective需配合translateZ的使用才能发挥出其真正的作用，如果没有配合translateZ使用，perspective设置多少都没有意义。

![image-20200314160902328](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224820.png)
...
![translate100px](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224839.png)

如果我们再将眼睛更加靠近屏幕（perspective减少），此刻元素在屏幕上的投影也会越来越大

![image-20200314154308370](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224846.png)
...
![translate-100](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224916.png)

如果我们再将眼睛更加靠近屏幕（perspective减少），此刻元素在屏幕上的投影会越来越小

![image-20200314155402212](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128224936.png)
...
![image-20200314163652660](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225007.png)
...
![image-20200314164557388](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225016.png)
...
![image-20200314170737189](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225022.png)
...
![image-20200315170510726](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225027.png)
...
![image-20200315175057126](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225032.png)
...
![image-20200315155158798](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225113.png)



![image-20200315160602181](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225113.png)
...
![image-20200316135556447](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225142.png)
...
![image-20200316144436056](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225208.png)

<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225230.png" alt="image-20200316143505806" style="zoom:150%;" />
...
![image-20200316144507423](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225241.png)
...
![逻辑屏幕](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/20210128225252.png)
