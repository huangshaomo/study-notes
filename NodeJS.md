...
- 所谓“运行环境（平台）”有两层意思：
  ...
  + 首先，JavaScript 语言通过 Node 在服务器运行，在这个意义上，Node 有点像 JavaScript 虚拟机；
    ...
    ![image-20200414123703745](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200414123901378.png)

    
  
  + 其次，Node 提供大量工具库，使得 JavaScript 语言与操作系统互动（比如读写文件、新建子进程），在这个意义上， Node 又是 JavaScript 的工具库。
  
    ![image-20200414123901378](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200414125203049.png)
...
![image-20200414125203049](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200414130349139.png)
...
- 做网站（处理用户所有的请求，然后给用户响应 ）【全包】
  ...
  ![image-20200414130009803](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200414130009803.png)

- 做分发（分发数据请求，渲染HTML页面）【只做一部分】

  ![image-20200414130349139](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801141410840.png)
...
![image-20200801135511583](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801135511583.png)

4. 配置环境变量 可以通过 window+r  : sysdm.cpl（都配置到用户变量中）

  + `NVM_HOME = 当前 nvm.exe 所在目录`

    ![image-20200801141410840](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801141450547.png)

  + `NVM_SYMLINK = node 快捷方式所在的目录`

    ![image-20200801141450547](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801141544484.png)

  + `PATH += %NVM_HOME%;%NVM_SYMLINK%;`

    如果添到用户变量nvm命令无法使用的话，再把%NVM_HOME%;%NVM_SYMLINK%添加到系统变量path中即可

    ![image-20200801141544484](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200414160754834-1596420001259.png)
...
cmd中查看配置的命令
 ...
 ![image-20200414160754834](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801220033530.png)
...
1. 下载：[nvm-windows](https://github.com/coreybutler/nvm-windows/releases/download/1.1.0/nvm-noinstall.zip),我们选择latest中的第一个：nvm-noinstall.zip，点击下载。
   ...
   ![image-20200801220033530](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801220211436.png)

2. 下载完成后解压到一个地方，我的是在`D:\Node` 里面的文件列表是这样的：elevate.cmd、elevate.vbs、install.cmd、LICENSE、nvm.exe，

   ![image-20200801220211436](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801212416663.png)
...
4. 配置环境变量 可以通过 window+r  : **sysdm.cpl**（都配置到用户变量中）
  ...
  + `NVM_HOME = 当前 nvm.exe 所在目录`
    ...
    <img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/SystemPropertiesAdvanced_EBEMws6Ctx.png" alt="image-20200801212416663" style="zoom: 80%;" />

  + `NVM_SYMLINK = node 快捷方式所在的目录`

    <img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801212512223.png" alt="image-20200801212512223" style="zoom:80%;" />

  + `PATH += %NVM_HOME%;%NVM_SYMLINK%;`

    如果添到用户变量nvm命令无法使用的话，再把%NVM_HOME%;%NVM_SYMLINK%添加到系统变量path中即可

    ![SystemPropertiesAdvanced_EBEMws6Ctx](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/notepad_JpKePMggNI.png)

  + 打开CMD通过`set [name]`命令查看环境变量是否配置成功，如下图

    ![image-20200414160754834](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200414160754834.png)

  + PowerShell中是通过`dir env:[name]`命令

    ![notepad_JpKePMggNI](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/PPEg6PudDZ.png)
...
![PPEg6PudDZ](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/explorer_FsEofOc9YA.png)
...
![explorer_FsEofOc9YA](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801222557122.png)

`nvm ls`

查看当前已安装所有的版本

![image-20200801222557122](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/cmd_O2Mkowo9AP.png)
...
>
> ![cmd_O2Mkowo9AP](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801130549130.png)
>
> ![image-20200801130549130](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801164204207.png)
>
> 我们可以下载一个全局包试试看，执行命令`npm install -g express`，可以看到，确实是下载到了c盘下面
>
> ![image-20200801164204207](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/explorer_lMZlXel19b.png)
>
...
>
> ![explorer_lMZlXel19b](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801225855712.png)
>
...
>
>  ![image-20200801225855712](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416144057556.png)
>
> 
>
> 我们为这个npm配置环境变量： 变量名为：NPM_HOME，变量值为 ：`%NVM_HOME%\node_global`
>
> ![image-20200416144057556](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/SystemPropertiesAdvanced_QbD52Aj6g2.png)
>
> 
>
> 在Path的最前面添加`;%NPM_HOME%`，注意了，这个一定要添加在 `%NVM_SYMLINK%`之前，所以我们直接把它放到Path的最前面
>
> ![SystemPropertiesAdvanced_QbD52Aj6g2](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801230955613.png)
>
> 至此，所有配置已完成，我们可以测试以下，全局安装一个mysql包，看看会不会安装在我们配置的路径中
>
> ![image-20200801230955613](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/explorer_OY87kmDL0L.png)
>
> 安装完后，mysql确实安装在了我们定义的路径中，至此，所有安装就已经完成了
>
> ![explorer_OY87kmDL0L](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801124658393.png)
>
> 扩展：
>
> **淘宝cnpm安装：**
...
>  ![image-20200801124658393](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801124944719.png)
>
>  下载完成后，双击安装包，开始安装，一直点`next`即可，安装路径默认在`C:\Program Files`下，也可以自定义修改
>
>  
>
>  ![image-20200801124944719](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801125119795.png)
>
>  我是放在`D:\Node\nvm\`下
>
>  ![image-20200801125119795](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801135857189.png)
>
...
>  安装完成如图所示
>
>  ![image-20200801135857189](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801125732287.png)
>
>  安装完成后，.msi格式的安装包已经将`node启动程序`添加到系统环境变量`path`中,查看系统变量验证
>
>  ![SystemPropertiesAdvanced_78poFFyRfO](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200801125629407.png)
>
>  既然已经将node程序添加到全局系统变量，我们可以直接在CMD窗口中任意位置执行`node`，打开CMD窗口，执行命令`node -v`查看node版本
>
>  ![image-20200801125629407](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/SystemPropertiesAdvanced_78poFFyRfO.png)
>
>  最新版的node在安装时同时也安装了npm,执行`npm -v`查看npm版本
>
>  ![image-20200801125732287](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200414183315028.png)
>
>  
>
...
<img src="https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200414235731381.png" alt="image-20200414235731381" style="zoom:80%;" />
...
![image-20200415095705577](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200415102054284.png)
...
node默认的形式是一个进程一个线程 
 ...
 ![image-20200415102054284](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200415122956328.png)
...
![image-20200415122956328](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200415123801904.png)
...
![image-20200415123801904](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200415203903631.png)
...
![image-20200415203903631](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200415212809287.png)
...
- **我们在之后的文件操作中必须使用绝对路径**
  ...
  ![image-20200415212809287](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200415212839766.png)

  用node 04去执行。

  ![image-20200415212839766](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200415213937070.png)
...
![image-20200415213937070](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200415230721881.png)
...
- module（模块对象）
  ...
  **载入一个模块就是构建一个Module实例**
  ...
  ![image-20200415215451606](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200415215451606.png)
...
![image-20200415230721881](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416095007852.png)
...
![image-20200416095007852](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416095103646-1596421032660.png)

如果删除.js文件后，就会查找.json文件

![image-20200416095103646](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416100317558-1596421039359.png)
...
![image-20200416100317558](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416100357399.png)

删除package.json后

![image-20200416100357399](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416105224483.png)
...
![image-20200416105224483](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416105713930.png)
...
![image-20200416105713930](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416111605924.png)
...
![image-20200416110206061](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416110206061.png)
...
![image-20200416111605924](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200417121726485.png)
...
![image-20200417121726485](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200417121900331.png)
...
![image-20200417121900331](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416184400347.png)
...
- **path.win32**
  ...
  ![image-20200416194056485](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416221238414.png)

- **path.posix**

  > 允许在任意操作系统上使用linux的方式操作路径

![image-20200416194027686](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200416194027686.png)
...
![image-20200416221238414](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200420115033330.png)
...
![image-20200420115033330](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200420172512795.png)
...
![image-20200420172512795](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200420172448499.png)
...
- **获取当前目录下的所有文件**
  ...
  ![image-20200420172448499](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200421165958561.png)
...
![image-20200421165958561](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200509200802435.png)
...
- fs.mkdir( path，callbacks )
  ...
  ![image-20200509200802435](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200509200925131.png)
  ...
  ![image-20200509200925131](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200509204614481.png)
...
![image-20200509204614481](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/G76NZYTXjZ.gif)
...
- `fs.watchFile(path,{interval:时间},listenr)`
  ...
  ![G76NZYTXjZ](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200509234055483.png)
...
![image-20200509234055483](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200510093200012.png)
...
![image-20200510093200012](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200510101954037.png)
...
![image-20200510101954037](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200510101011272.png)
...
1. `fs.createReadStream`:通知操作系统在内存中创建一个缓冲区(buffer)，并建立磁盘中的文件与内存缓冲区之间的联系（缓冲区（buffer ）的大小由操作系统决定，一般是35536个字节）
   ...
   ![image-20200510101011272](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200510101731089.png)
...
![image-20200510101731089](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200510102742097.png)
...
![image-20200510102742097](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200510101011272-1596421477280.png)
...
![ml6eJ71jgV](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/ml6eJ71jgV.gif)

2. `fs.createWriteStream`：一样的，通知操作系统在内存中创建一个缓冲区(buffer)，并建立内存缓冲区与磁盘中的文件之间的联系（缓冲区（buffer ）的大小由操作系统决定，一般是35536个字节）

   ![image-20200510101011272](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200510114848779.png)
...
![image-20200510114848779](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200510122821457.png)
...
![image-20200510122821457](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/X1kbbCrA45.gif)
...
![ZKKi1dlvj5](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/ggf8laUQ5f.gif)
...
![X1kbbCrA45](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/lAe12ajtVg.gif)
...
![ggf8laUQ5f](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200510194544349.png)
...
![lAe12ajtVg](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/5JnB3ihBpx.gif)
...
![image-20200510194544349](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200511080921534.png)
...
![5JnB3ihBpx](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200511192939203-1596421609106.png)

![image-20200511080921534](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200511191706924.png)
...
![image-20200511192939203](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200511191533184.png)

![image-20200511191706924](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200511192820192-1596421651359.png)
...
![image-20200511191533184](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/image-20200414123703745.png)

![image-20200511192820192](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/ZKKi1dlvj5.gif)
