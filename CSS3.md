...
div ~ p的意思是：找到div元素下的所有的兄弟元素节点p，只要下面存在兄弟元素节点p，就会被选中
...
水平偏移量：以原点为坐标轴，阴影往左或右偏移，正数往右，负数往左

垂直偏移量：以原点为坐标轴，阴影往上或下偏移，正数往下，负数往上
...
![4o812nDTEI](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/4o812nDTEI.png)
...
![360chrome_m6zecdO0vx](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/360chrome_m6zecdO0vx.png)
...
![chrome_DHgxz1dcYw](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/chrome_DHgxz1dcYw.png)
...
![RYQ1GFKkxv](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/RYQ1GFKkxv.gif)
...
![chrome_XoWVjE1MRw](https://hsm-typora-img.oss-cn-beijing.aliyuncs.com/img/chrome_XoWVjE1MRw.png)

transform-origin：用于设置所有transform属性的旋转轴位置。默认值center center
